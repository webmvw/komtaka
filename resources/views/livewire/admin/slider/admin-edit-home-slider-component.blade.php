		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="row">
						<div class="col-md-6">
							<div class="panel-title">Edit Home Slider</div>
						</div>
						<div class="col-md-6">
				...
				<div class="panel-body">
				    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            @endif
                            <form wire:submit.prevent="homesliderupdate" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    @elseif($image)
                                    <img src="{{asset('assets/images/homeslider/'.$image)}}" style="width:120px;">
                                    @endif
                                </div>
